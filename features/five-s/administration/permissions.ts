...
export const ROLE_PRESETS:Record<AdminRole,PermissionCode[]>={
  Admin:all,
  Auditor:["dashboard.view","audits.view","audits.create","audits.execute","audits.complete","actions.view","actions.create","reports.view","reports.export","ci.view","red_tag.view"],
  "Zone Leader":["dashboard.view","audits.view","actions.view","actions.assign","actions.review","actions.close","reports.view","ci.view","ci.review","red_tag.view","red_tag.manage","red_tag.print"],
